...
public class LimelightHelpers {
    ...
    public static class Results {
        ...
        public Pose3d getBotPose3d_wpiBlue_MegaTag2() {
            return toPose3D(botpose_orb_wpiblue);
        }
    ...
    public static LimelightResults parseJSONDump(String dump) {
        ...
        try {
            results = mapper.readValue(dump, LimelightResults.class);
    ...
    public static LimelightResults getLatestResults(String limelightName) {
        String dump = getJSONDump(limelightName);
        return parseJSONDump(dump);
    }
